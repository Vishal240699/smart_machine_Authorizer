...
<!--                <h5 class="card-category">Utkarsh Shukla</h5>-->
                <h4 class="card-title">Tools Authorization</h4>
                <div class="dropdown">
            ...
            <div class="card card-chart">
              <div class="card-header">
                ...
                <div class="dropdown">
                  ...
                  <div class="dropdown-menu dropdown-menu-right">
                    <a class="dropdown-item" href="tabless%20M.php">Machine Authorize</a>
                       <a class="dropdown-item" href="tables%20M1.php">Log</a>
