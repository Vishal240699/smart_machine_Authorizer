...
{   //sql query
  $sql="SELECT subject,Description FROM notice;";
  $res=$link->query($sql);
}
?>
<!DOCTYPE html>
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            </div>            <a class="navbar-brand" href="#pablo">Notifications</a>
          </div>
<!--
...
-->
                <?php
                  ...
                  {
                      echo "<div class='alert alert-info alert-with-icon' data-notify='container'><button type='button' aria-hidden='true' class='close'><i class='now-ui-icons ui-1_simple-remove'></i></button><span data-notify='icon' class='now-ui-icons 1_bell-53'></span><span data-notify='message'>subject:{$row['subject']}<br><br>message:{$row['Description']}</span></div>";
                  }
                  ?>
              </div>
            </div>
